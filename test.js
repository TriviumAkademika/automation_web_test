...
async function runTest() {
    ...
    try {
        ...
        await driver.wait(until.elementLocated(By.xpath('//a[.//button[text()="Tambah Dosen"]]')), 10000);
        let tambahDosenButton = await driver.findElement(By.xpath('//a[.//button[text()="Tambah Dosen"]]'));
        ...
        await namaDosenInput.sendKeys('Gemini AI Dosen');
        ...
        await alamatInput.sendKeys('Jl. AI No. 101');
        ...
        await noHpInput.sendKeys('081234567890');
        console.log('Berhasil mengisi No HP.');

        // Klik tombol Simpan.
        let simpanButton = await driver.wait(until.elementLocated(By.xpath('//button[text()="Simpan"]')), 10000);
